...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_socket_io_client__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_socket_io_client___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_socket_io_client__);
const whiteboard = __webpack_require__(25);
// const socket = require('socket.io-client');


console.log(__WEBPACK_IMPORTED_MODULE_0_socket_io_client___default.a)
__WEBPACK_IMPORTED_MODULE_0_socket_io_client___default.a.on('connect', function () {
  console.log('Connected!');
});

__WEBPACK_IMPORTED_MODULE_0_socket_io_client___default.a.on('load', function (strokes) {
...
__WEBPACK_IMPORTED_MODULE_0_socket_io_client___default.a.on('draw', function (start, end, color) {
  whiteboard.draw(start, end, color, false);
});

whiteboard.on('draw', function (start, end, color) {
  __WEBPACK_IMPORTED_MODULE_0_socket_io_client___default.a.emit('draw', start, end, color);
});
